...
def lambda_handler(event=None, context=None):
    ...
    response = requests.get("https://tver.jp/talents/t00eaf3")
    ...
    # realtime_tvs =  soup.find("div", class_="arrow-floated-horizontal-scrollable-container_scrollContent")
    # realtime_tvs =  soup.find("div", {"class": "arrow-floated-horizontal-scrollable-container_scrollContent"}, partial=True)
    realtime_tvs =  soup.select('div[class*="arrow-floated-horizontal-scrollable-container_scrollContent"]')

    # pages = soup.find("ul", class_="articleList")
    print("realtime_tvs", realtime_tvs)
